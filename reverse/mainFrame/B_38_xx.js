...
exports.B_38_74 = exports.B_38_29 = exports.B_38_44 = void 0;
const initialState_1 = require("./initialState");
const sH_1 = require("./sH");
const HV_1 = require("./HV");
    ...
    T = function (l, r, U, E) {
        ...
        function arg_375(H, f, V) {
            if (H.S == 1) {
                var var_68 = Cf || U;
                Cf = var_68;
                var var_69 = r || initialState_1.eH;
                initialState_1.setEH(var_69);
                var arg_377 = m_35_20(5, l);
                q = Math.abs(arg_377);
                var arg_378 = new sH_1.sH();
                d = B_4_6(2, arg_378, q);
                if (J) {
                    function arg_381(u) {
...
exports.B_38_74 = B_38_74;
function k_5_52(Q) {
    var n;
    var G;
    n = n = ((Q ^ initialState_1.f1 | 3) >> 5) + initialState_1.f1;
    G = initialState_1.g3[(n % 50 + 50) % 50];
    return G;
}
function k_5_65(Q) {
    var n;
...
function B_47_29(Q, n, J, M) {
    ...
    var G;
    var arg_411 = J + M;
    x = m_13_10(Q, 255, arg_411, initialState_1.VC);
...
function k_18_5(Q, n, J, M) {
    ...
    x = B_47_29(17, arg_959, arg_960, initialState_1.OH);
...
//# sourceMappingURL=B_38_xx.js.map